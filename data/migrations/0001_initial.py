# Generated by Django 4.1.7 on 2023-06-28 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluador', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.evaluador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.OneToOneField(null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.estado')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='estado',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.estado'),
        ),
        migrations.AddField(
            model_name='domicilio',
            name='municipio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentarios', models.TextField(blank=True, null=True)),
                ('personal', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='data.personal')),
                ('puesto', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.puesto')),
            ],
            options={
