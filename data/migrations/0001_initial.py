...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('folio', models.CharField(default='SIN FOLIO', max_length=10)),
                ...
                ('observaciones', models.TextField(blank=True, null=True)),
                ('resultado', models.PositiveSmallIntegerField(choices=[(1, 'APTO'), (2, 'APTO BAJO RESERVA'), (3, 'NO APTO'), (4, 'NO INICIA PROCESO'), (5, 'NO FINALIZA PROCESO'), (6, 'NO SOLICITADO')])),
        ...
        migrations.AddField(
            model_name='personal',
            name='rfc',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.rfc'),
        ),
        migrations.CreateModel(
            name='Pais',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carp_emp_ant', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaempleoanterior')),
                ('carp_emp_ant_seg_pub', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaempleoanteriorseguridadpublica')),
                ('cliente_generales', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaclientegenerales')),
                ('cliente_pagos', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaclientepagos')),
                ('personal', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='data.personal')),
