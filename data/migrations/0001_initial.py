# Generated by Django 4.1.7 on 2023-10-13 23:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capacitacion', models.ManyToManyField(blank=True, related_name='capacitacionesencurso', to='data.capacitacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capacitacion', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.capacitacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rfc', models.CharField(max_length=13, validators=[django.core.validators.RegexValidator('^[A-Za-z]{3,4}(\\d{6})([A-Za-z]\\d{2}|(\\D|\\d){3})?$', 'El RFC ingresado no es válido')])),
                ('rfc_digital', models.FileField(blank=True, unique=True, upload_to=data.models.get_upload_path)),
                ...
                ('personal', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.personal')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='RepresentanteTrabajadores',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_completo', models.CharField(blank=True, max_length=300, null=True)),
                ('firma', models.FileField(blank=True, null=True, upload_to='firma-representantes')),
                ('reglamento_interno', models.FileField(blank=True, null=True, upload_to='reglamentos-trabajo')),
                ('cliente', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.cliente')),
                ('personal', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.personal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carpeta_laboral', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.carpetalaboral')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_ocupacion', models.CharField(blank=True, max_length=100, null=True)),
                ('carpeta_laboral', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.carpetalaboral')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.estado')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='estado',
            name='pais',
            field=models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.pais'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivo_separacion', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.motivoseparacion')),
                ('puesto_funcional', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.puestofuncional')),
                ('tipo_baja', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.tipobaja')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observaciones', models.TextField(blank=True, null=True)),
                ('carp_emp_ant', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='data.carpetaempleoanterior')),
                ('motivo_separacion', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.motivoseparacion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carpeta_cliente_generales', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaclientegenerales')),
                ('carpeta_cliente_pagos', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.carpetaclientepagos')),
                ('codigo_postal', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.codigopostal')),
                ('colonia', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.colonia')),
                ('empleo_anterior', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.empleoanterior')),
                ('empleo_anterior_sp', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.empleoanteriorseguridadpublica')),
                ('estado', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.estado')),
                ('municipio', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.municipio')),
                ('pais', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.pais')),
                ('personal', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.personal')),
                ('referencia', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='data.referencia')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hoja_datos', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('solicitud', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('ine', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('acta_nacimiento', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('folio_acta_nacimiento', models.CharField(blank=True, max_length=20, null=True)),
                ('huellas_digitales', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('curp', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('comprobante_domicilio', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_comprobante_domicilio', models.DateField(blank=True, null=True)),
                ('antecedentes_no_penales', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_antecedentes_no_penales', models.DateField(blank=True, null=True)),
                ('comprobante_estudios', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('cartilla_smn', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('nss', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('carta_recomendacion', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('contrato', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('socioeconomico', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_socioeconomico', models.DateField(blank=True, null=True)),
                ('foto_socioeconomico', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('psicologico', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_psicologico', models.DateField(blank=True, null=True)),
                ('medico', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_medico', models.DateField(blank=True, null=True)),
                ('toxicologico', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_toxicologico', models.DateField(blank=True, null=True)),
                ('fisico', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('fecha_fisico', models.DateField(blank=True, null=True)),
                ('croquis', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('curriculum', models.FileField(blank=True, null=True, upload_to=data.models.get_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qr_code', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
                ('logotipo', models.ImageField(blank=True, null=True, upload_to=data.models.get_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('curp', models.CharField(max_length=18, unique=True, validators=[django.core.validators.RegexValidator('^[A-Z]{1}[AEIOU]{1}[A-Z]{2}[0-9]{2}(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])[HM]{1}(AS|BC|BS|CC|CS|CH|CL|CM|DF|DG|GT|GR|HG|JC|MC|MN|MS|NT|NL|OC|PL|QT|QR|SP|SL|SR|TC|TS|TL|VZ|YN|ZS|NE)[B-DF-HJ-NP-TV-Z]{3}[0-9A-Z]{1}[0-9]{1}$', 'La CURP no es válida')])),
                ('nombre', models.CharField(max_length=100)),
                ('apellido_paterno', models.CharField(max_length=100)),
                ('apellido_materno', models.CharField(max_length=100)),
                ...
                ('validacion_renapo', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'SI'), (2, 'NO'), (3, 'DESCONOCIDO')], null=True)),
                ('sexo', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'MUJER'), (2, 'HOMBRE'), (3, 'NO BINARIO')], null=True)),
        ...
        migrations.AddField(
            model_name='colonia',
            name='municipio',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='data.municipio'),
        ),
        migrations.AddField(
            model_name='codigopostal',
            name='colonia',
            field=models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='data.colonia'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cejas_tamanio', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'GRUESAS'), (2, 'DELGADAS'), (3, 'CORTAS'), (4, 'LARGAS')], verbose_name='Cejas tamaño')),
                ...
                ('ojos_tamanio', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'GRANDES'), (2, 'PEQUEÑOS'), (3, 'REGULARES')], verbose_name='Ojos tamaño')),
                ...
                ('boca_tamanio', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'GRANDE'), (2, 'MEDIANA'), (3, 'PEQUEÑA')], verbose_name='Boca tamaño')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anios_residencia', models.CharField(blank=True, max_length=10, null=True, verbose_name='Años residencia')),
                ('niveles', models.CharField(blank=True, max_length=4, null=True)),
                ('cuartos', models.CharField(blank=True, max_length=5, null=True)),
                ('banos', models.CharField(blank=True, max_length=3, null=True, verbose_name='Baños')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_capacitador', models.CharField(blank=True, max_length=300, null=True)),
                ('numero_registro', models.CharField(blank=True, max_length=14, null=True)),
                ('carpeta_laboral', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.carpetalaboral')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_area', models.CharField(blank=True, max_length=100, null=True)),
                ('carpeta_laboral', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='data.carpetalaboral')),
            ],
            options={
